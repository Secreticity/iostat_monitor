...
filepath='/home/kau/jwbang/200320/out_mod16mix_iostat.txt'
logpath='/home/kau/jwbang/200320/log_folder/log.iostat'

write=0

echo '' > /home/kau/jwbang/200320/out_mod16mix.txt
echo '' > $filepath
echo ${filepath} >> $logpath

while true
do
  str=`echo $(cat /home/kau/jwbang/200320/out_mod16mix.txt | tail -1)`
  if [[ $str =~ ^P ]]; then
    if [ $write -eq 0 ]; then
      write=1
      echo 'start----' >> $filepath
